...
def wrap_text(c, text, width, margin, y):
    """Wraps text to fit within the page margins and returns updated y position."""
...
def create_pdf_from_csv(csv_file, output_pdf):
    ...
    for index, row in data.iterrows():
        ...
        y = remaining_y - 15  # Adjust spacing after wrapped question
        ...
        if q_type == "text":
            ...
            for option in options:
                ...
                c.circle(margin + 10, y - 10, 5) if q_type == "radio" else c.rect(margin + 5, y - 15, 10, 10)
...
# Example usage
csv_file = "test.csv"
output_pdf = "questionnaire_form_v3.pdf"
